...
model = YOLO("./Desarrollo/simulation/Env03/models_params_weights/YOLO/yolo11m-seg.pt") #"yolov8n-seg.pt"

img = cv2.imread("./Desarrollo/simulation/Env03/DataSets/RawTools/calibre01.png")
