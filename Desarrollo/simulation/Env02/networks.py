...
class ActorNetwork(nn.Module):
    ...
    def __init__(self, input_dims, n_actions, conv_channels=[16, 32, 64], hidden_size=256, name='actor', checkpoint_dir='Desarrollo/simulation/Env02/tmp/td3', learning_rate=0.001):
