...
model = YOLO("./Desarrollo/simulation/Env05/models_params_weights/YOLO/yolo11m-seg.pt") #"yolov8n-seg.pt"

img = cv2.imread("./Desarrollo/simulation/Env05/DataSets/RawTools/calibre01.png")
