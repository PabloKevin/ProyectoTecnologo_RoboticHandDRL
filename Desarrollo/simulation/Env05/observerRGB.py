...
class ObserverNetwork(nn.Module):
    ...
    def __init__(self, 
                 ...
                 name='observer', checkpoint_dir='Desarrollo/simulation/Env05/tmp/observer'):
...
if __name__ == "__main__":
    ...
    # logs file
    log_path = "Desarrollo/simulation/Env05/"
    ...
    train_dataset_dir = "Desarrollo/simulation/Env05/DataSets/TrainSet_masks"
    test_dataset_dir = "Desarrollo/simulation/Env05/DataSets/TestSet_masks"
