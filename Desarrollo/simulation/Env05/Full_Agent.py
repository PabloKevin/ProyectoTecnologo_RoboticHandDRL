...
class Full_Agent_Pipe():
    def __init__(self, env=None, segmentator=None, observer=None, actor=None, checkpoint_dir="Desarrollo/simulation/Env05/models_params_weights/"): 
        """if env is None:
    ...
    def pipe(self, input_img=None, dataset_name="RawTools", render=True, render_timeout=3):
        if input_img is None:
            image_dir = "Desarrollo/simulation/Env05/DataSets/" + dataset_name
