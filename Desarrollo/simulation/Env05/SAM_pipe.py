...
class Segmentator(): 
    def __init__(self, checkpoint_dir="Desarrollo/simulation/Env05/models_params_weights/SAM/sam_vit_b_01ec64.pth", output_dims=(256, 256)):
...
"""if __name__ == "__main__":
    # 2) Loop over images
    #image_dir = "Desarrollo/simulation/Env05/DataSets/Herramientas_Complicadas"
    image_dir = "Desarrollo/simulation/Env05/DataSets/RawTools"
