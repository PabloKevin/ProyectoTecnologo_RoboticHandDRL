...
class CriticNetwork(nn.Module):
    ...
    def __init__(self, input_dims,  hidden_layers=[128,64], name='critic', checkpoint_dir='Desarrollo/simulation/Env04/tmp/td3', 
                 learning_rate=0.001):
...
class ActorNetwork(nn.Module):
    ...
    def __init__(self, input_dims=2, n_actions=1, hidden_layers=[64,32], name='actor', checkpoint_dir='Desarrollo/simulation/Env04/tmp/td3', learning_rate=0.001):
...
class ObserverNetwork(nn.Module):
    ...
    def __init__(self, input_dims = (256, 256, 1), output_dims = 1, conv_channels=[16, 32, 64], hidden_layers=[64,8], 
                 name='observer', checkpoint_dir='Desarrollo/simulation/Env04/tmp/observer', learning_rate=0.001,
