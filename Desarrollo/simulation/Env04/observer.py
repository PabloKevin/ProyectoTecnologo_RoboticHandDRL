...
class DynamicBatchGenerator:
    ...
    def get_image(self):
        ...
        image_dir = "Desarrollo/simulation/Env04/DataSets/B&W_Tools/"
...
class ObserverNetwork(nn.Module):
    ...
    def __init__(self, input_dims, output_dims = 1, conv_channels=[16, 32, 64], hidden_layers=[64,8], name='observer', checkpoint_dir='Desarrollo/simulation/Env04/tmp/observer', learning_rate=0.001):
...
class Trainer():
    def __init__(self, batch_size = 32, image_shape = (256, 256, 1), epochs = 20, batches_per_epoch = 100, learning_rate = 0.001, checkpoint_dir="Desarrollo/simulation/Env04/models_params_weights/"):
        # Parameters
        self.batch_size = batch_size
        self.image_shape = image_shape
        self.epochs = epochs
