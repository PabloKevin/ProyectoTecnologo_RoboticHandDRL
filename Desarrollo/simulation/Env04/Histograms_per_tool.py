...
for j, tool_name in enumerate(tools_of_interest):
    env = ToolManipulationEnv(image_shape=(256, 256, 1), n_fingers=1, images_of_interest=[tool_name], dataset_dir="Desarrollo/simulation/Env04/DataSets/", dataset_name="TestSet_masks")
